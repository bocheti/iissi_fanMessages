...
export default function EditRestaurantScreen ({ navigation, route }) {
  ...
  const [initialRestaurantValues, setInitialRestaurantValues] = useState({ name: null, description: null, address: null, postalCode: null, url: null, shippingCosts: null, email: null, phone: null, restaurantCategoryId: null, fanMessage: null, logo: null, heroImage: null })
